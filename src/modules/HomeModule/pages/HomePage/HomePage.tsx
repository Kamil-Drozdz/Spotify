		...
		<>
			...
			<div style={containerStyle} className='home-page'>
				<div className='home-page-header'>
					<h2 id='categories' className='home-page-header__title'>
						Your favorite categories
					</h2>
				</div>
				<div className='category-list'>
					{categories?.map(category => (
						<a href='#categories-details' className='category-list__item' key={category?.id} onClick={() => handleCategoryClick(category?.id, category?.icons[0].url)}>
